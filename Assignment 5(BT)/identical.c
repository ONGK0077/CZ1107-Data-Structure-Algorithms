...
{
   /* add your code here */
   BTNode *temp_tree_1, *temp_tree_2;
   temp_tree_1 = tree1;
   temp_tree_2 = tree2;

   if (temp_tree_1 == NULL && temp_tree_2 == NULL){
        return 1;
   }
   else if (temp_tree_1 != NULL && temp_tree_2 == NULL){
        return 0;
   }
   else if (temp_tree_1 == NULL && temp_tree_2 != NULL){
        return 0;
        ...
        if ((temp_tree_1->item == temp_tree_2->item)
            && identical(temp_tree_1->left,temp_tree_2->left)
            && identical(temp_tree_1->right,temp_tree_2->right)){
            return 1;
        }
        else{
            return 0;
